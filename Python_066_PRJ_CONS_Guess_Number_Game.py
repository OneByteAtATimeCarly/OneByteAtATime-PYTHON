# Title: Project - Guess Number Game 1
...
def Play_Game():
    ...
    print("  Welcome to a new game, ",PlayerName,".");
    ...
    print("\n ",PlayerName," you have ",round(math.log(Number_High - Number_Low + 1, 2))," guesses left to guess my number.\n");
