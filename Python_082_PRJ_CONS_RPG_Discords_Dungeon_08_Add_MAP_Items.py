...
#Title: Discord's Dungeon 08 - Adding Inventory Items, Skills, Potions, Puzzles, Traps and Other Objects to MAP. Doing MORE with LESS code using FUNCTIONS, returning values, global vs. local scope.
...
#Function----------------------------------------------------------------------------------------------------------------------------------------------------------------
def Find_Healing_Potion(PotionNumber):
    
    CHOICE = "";

    if(PotionNumber == "FALSE"):
