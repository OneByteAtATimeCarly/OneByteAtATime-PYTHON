...
def Create_NPCs(): 
    system("cls");
    print(" Third, we must build the NPC(s).");
                ...
                if(CHOICE == "o"):
                   Options();
                        ...
                        while(CHOICE != "y" and CHOICE != "#"):
                              ...
                              if(CHOICE == "y"):
                                 ...
                                 Player_Heroine.SKILL_Display(); 
                                   ...
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an empty bowl of fruit rings on the table where you formerly found the scroll of Friendship Cast.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
                     ...
                     if(globals()['TRAP2_Encountered'] == "FALSE"):
                        print(" To the west in a small, rusty cage you see a poor, grumpy, fluffy Pallas cat (Manul).");
