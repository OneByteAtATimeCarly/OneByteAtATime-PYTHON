...
#Title: Discord's Dungeon 05 - Coding MAP and Navigation. Manipulating, Using and Organizing Your Code With Functions.
...
def Game_MAP():
    ...
    print("  └───────────────────┘         └────┘                                         ");
    print("");
    ContinueIT = input("  Press ENTER to proceed."); 
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
