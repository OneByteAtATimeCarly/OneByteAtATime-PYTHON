#Title: Discord's Dungeon - A Python Text-Based RPG
...
#Discord's Dungeon 09 - Coding NPCs (Non-Player Characters). Emulating Basic AI and Responsiveness.
...
#MAP L1 Combat Globals
Combat1_Not_Complete = "TRUE";
Combat2_Not_Complete = "TRUE";
...
def Create_Character(): 
    ...
    print("\n 1st, we must Instantiate your created character as the player object.");
...
def Create_Antagonists(): 
    system("cls");
    print(" 2nd, we must build the opponent object(s).");

    #1 - Instantiating Single Boss Antagonist
    print("\n Instantiating solitary Boss Chaos_Agent Antagonist.");
    globals()['Player_Opponent'] = Chaos_Agent();
    Player_Opponent.Display_All();

    #2 - Instantiating Array and Populating With 3 Antagonists
    print("\n Instantiating 3 Antagonists and Populating Array.");
    globals()['Opponent_Group'].append(ANTAGONIST("Bob"));
    globals()['Opponent_Group'].append(ANTAGONIST("Joe"));
    globals()['Opponent_Group'].append(ANTAGONIST("Guss"));

    #Display stats for all Antagonists in array
    for x in Opponent_Group:
        print("\n----------------------------------------------------------------"); 
        x.Display_All();
...
def Create_NPCs(): 
    system("cls");
    print(" 3rd, we must build the NPC(s).");

    #NPC 1
    print("\n Instantiating NPC 1.");
    globals()['NPC_1'] = NPC("Madrigastafula","NPC Pony"); 
    NPC_1.Display_All();  

    RAND_Responses = ["Odd weather we seem to be having today, eh?",
                      "And then she turned to me and said \"WHATEVER!\". The nerve of that pony.",
                      "Seems like everypony has a sad story these days.",
                      "Why do today what you can put off until tomorrow?",
                      "A stitch in time saves nine.",
                      "I have a headache.",
                      "Fancy meeting you here!",
                      "What are the odds that you and I are thinking the same thing?",
                      "Is anything ever what it seems in this place?",
                      "All we are is dust in the wind. Dude."];              

    NPC_1.Set_Random_Responses(RAND_Responses);
    #NPC_1.Speak();     

    #NPC 2
    print("\n Instantiating NPC 2.");
    globals()['NPC_2'] = NPC("Chrystalia","Alicorn"); 
    NPC_2.Display_All();  
    ...
    RAND_Responses = ["Fore score and seven yarns ago ...",
                      ...
                      "Don't go out tonight. You're bound to lose your life. I see a bad moon on the rise.",
    ...
    NPC_2.Set_Random_Responses(RAND_Responses);
    #NPC_2.Speak(); 

    #NPC 3
    print("\n Instantiating NPC 3.");
    globals()['NPC_3'] = NPC("Raya","Pegasus"); 
    NPC_3.Display_All();  

    RAND_Responses = ["When the last eagle flies over the last crumbling mountain?",
    ...
    NPC_3.Set_Random_Responses(RAND_Responses);
    #NPC_3.Speak(); 
    ContinueIT = input("\nPress ENTER to proceed.");
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#Function----------------------------------------------------------------------------------------------------------------------------------------------------------------
def Display_Combat_Stats(Player_Heroine,Player_Opponent):
    print("\n");
...
#Function----------------------------------------------------------------------------------------------------------------------------------------------------------------
def Pony_Combat(Player_Heroine,Player_Opponent):
    MinDammage = 25;
    MaxDammage = 100;
  ...
  #1.Display names of instantiated class objects engaging in combat using pointers to globals
    ...
    Display_Combat_Stats(Player_Heroine,Player_Opponent);  
    time.sleep(2); 
                        ...
                        while(CHOICE != "y" and CHOICE != "#"):
                              ...
                              if(CHOICE == "y"):
                                 ...
                                 if(LadyLuck == 6):
                                    ...
                                    print("\n You pull out the parchment inside and unfold it. It contains details for exciting molecules");
                                    print(" to create intense heat and spontaneous flame. You acquire the skill: Fire Balls!");
                                    ...
                                    Player_Heroine.SKILL_Display(); 
                                       ...
                                       print("An energy bolt emanates from the box shocking you and doing 5 points of dammage.");
                              ...
                              print("\n You see the key still in the empty box where you formerly found the FireBall scroll."); 
                              print(" You formerly flirted with Lady Luck here, and rolled a 6.");
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     print("\n You try to ascend the exposed mountain-side, but it is far too steep and you keep sliding back."); 
                     if(globals()['Found_Pendant'] == "FALSE"):
                        VIEW = "\n To the EAST you see a silver glimmer i nthe limbs of a small evergreen. ";
                        VIEW = VIEW + "\n Could it be a trick of the light? Something valuable? A trap?";
                        print(VIEW);          
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Investigate? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You decide to investigate. As you approach the evergreen, the glimmer begins to take shape into a");
                                 print(" beautiful pendant! Encrusted with saphires, it glows with an erie blue light.");
                                 print(" You find: the \"Pendant of PonyOne!\"");
                                 Player_Heroine.INV_Has_Pendant = "TRUE";
                                 globals()['Found_Pendant']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" It might be a trap or just an illusion. You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                    print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see a bare limb on an evergreen where you formerly found the pendant.");                      
                     ContinueIT = input("\n Press ENTER to proceed.");
                elif(CHOICE == "w"):
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['TRAP1_Encountered'] == "FALSE"):
                        print(" You see a metal box with a lever on its side and a bell on top. ");
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pull the lever? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n [TRAP1] Boom! It was all a trap. The box blows up, piercing your skin with tiny slivers");
                                 print(" of metal shrapnel. If only you had been more careful?");
                                 Player_Heroine.EntityHealth = Player_Heroine.EntityHealth - 10;
                                 globals()['TRAP1_Encountered']  = "TRUE";
                                 print("Current health - 10 =",Player_Heroine.EntityHealth); 
                              elif(CHOICE == "n"):
                                   print(" It might be a trap or just an illusion. You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                            ...
                            print("\n You see an empty, deactivated metal trap box. The one you had previously triggered here.");
                            print(" Several small river otters whom you had previously met before gather around you empathetically.");                        
                     ContinueIT = input("\n Press ENTER to proceed.");
                elif(CHOICE == "w"):
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Acquired_Lightning'] == "FALSE"):
                        VIEW = "\n You walk over to the broken apple cart. You notice a small plank with symbols inscribed on the";
                        VIEW = VIEW + "\n side of the cart. What could these symbols mean?";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Read the strange symbols out loud? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You decide to read the strange symbols on the plank out loud. Above your head, the clouds");
                                 print(" begin to part and the air around you electrifies. A massive bolt of energy fires from heaven");
                                 print(" to earth. You acquire skill: Lightning!");
                                 Player_Heroine.SKILL_Has_Lightning = "TRUE";
                                 globals()['Acquired_Lightning']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide the strange symbols must be gibberish. Not worth reading aloud.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see the engraved wooden plank where you formerly learned the skill of LIGHTNING.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
                elif(CHOICE == "e"):
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Acquired_Telepathy'] == "FALSE"):
                        print(" She wants to sell you some flowers, but you have nothing to buy them with.");
                        print(" Even so, she offers you the petals of a bright yellow flower. She takes a few.");
                        print(" and puts them in her mouth, making a chewing motion. She is asking you to eat them! Will you?");  
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Eat the yellow flower petals? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 VIEW = "\n You place the petals in your mouth. As you chew them, they taste sweet.";
                                 VIEW = VIEW + "\n As soon as you swallow them you hear a voice not your own spealing in your mind.";
                                 VIEW = VIEW + "\n It's the voice of the old mare! ";
                                 print(VIEW);
                                 Player_Heroine.SKILL_Has_Telepathy = "TRUE";
                                 globals()['Acquired_Telepathy']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide it's too dirty and gross. No telling what's in that crevice!");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Acquired_Telekinesis'] == "FALSE"):
                        VIEW = "\n In the ice slope you see wahat seems to be a blue box made of transparent ice. ";
                        VIEW = VIEW + "\n In the box you see a small scroll.";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Open the ice box, pull out the scroll and try to read it? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You open the ice box and pull out the scroll and unroll it. It contians details for moving");
                                 print(" objects with your mins and mind over matter. You acquire skill: Telekinesis!");
                                 Player_Heroine.SKILL_Has_Telekinesis = "TRUE";
                                 globals()['Acquired_Telekinesis']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide not to open it. What if it's a trap? Better to excercise caution.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an empty ice box where you formerly found the scroll of Telekinesis.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
                elif(CHOICE == "s"):
                     globals()['CurrentLocation'] = "L1_NORTH_2"; 
                elif(CHOICE == "e"):
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     print("\n You try to advance south, but are blocked by impenetrable rows of trees.");
                     print(" The trees appear to have been petrified and turned to stone ages ago."); 
                     if(globals()['Acquired_Healing'] == "FALSE"):
                        VIEW = "\n At the base of one of the petrified trees you see a an abandoned satchel. ";
                        VIEW = VIEW + "\n Do you want to pick it up and look inside?";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pick up the satchel and look inside? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You pick up the satchel and look inside. You find a small rolled parchment detailing the art of");
                                 print(" healing yourself and others through the laying on of hands. You acquire skill: Healing!");
                                 Player_Heroine.SKILL_Has_Healing  = "TRUE";
                                 globals()['Acquired_Healing']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide not to pick up the satchel. Something inside it might harm you.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n At the base of a petrified tree you see the empty satchel where you formerly found the scroll for healing.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['TRAP3_Encountered'] == "FALSE"):
                        print(" You see a small wooden table against the south wall of the stable. On this table is a plate of");
                        print(" delicious looking butter cremem frosted strawberry cupcakes. You can small the strawberry aroma");
                        print(" and it tingles your nostrils and makes your stomach growl. So yummy! Irresistible.");
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Try a straberry cupcake? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n [TRAP3] You pick up one and take a bite. Though sweet in your mouth, it is sour in your tummy.");
                                 print(" It makes you feel naueous and weak in the knees. You quickly throw up. The poison");
                                 print(" from the cupcakes does 10 points of dammage to your system.");
                                 Player_Heroine.EntityHealth = Player_Heroine.EntityHealth - 10;
                                 globals()['TRAP3_Encountered']  = "TRUE";
                                 print("Current health - 10 =",Player_Heroine.EntityHealth); 
                              elif(CHOICE == "n"):
                                   print(" the cupcakes might be poisonous or have some other undesired consequence when eaten.");
                                   print(" You decide to leave them alone.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                    print(" That choice was invalid. Ignoring it.");
                     else : 
                            print("\n You see a plate uf cupcakes, minus the one you ate that poisoned you when last  you came.");                    
                     ContinueIT = input("\n Press ENTER to proceed.");
                     ...
                     if(globals()['Found_Sigil'] == "FALSE"):
                        VIEW = "\n On the stone table something metallic glimmers with a silver sheen.";
                        VIEW = VIEW + "\n You wonder - would it be SAFE to touch this glimmering metallic object?";
                        print(VIEW);       
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pick up the object? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You decide to pick it up and investigate it further. As you touch it, you feel strangely");
                                 print(" stronger, as if you could carry a house on your back all by yourself. It vibrates ever so slilghtly,");
                                 print(" tickling in strange way. You find: the \"Sigil of Sparkly Specialness!\"");
                                 Player_Heroine.INV_Has_Sigil = "TRUE";
                                 globals()['Found_Sigil']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" It might be a trap or just an illusion. You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                                   ...
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an empty spot on the stone table where you formerly found the Sigil of Sparkly Specialness.");  
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Found_Orb'] == "FALSE"):
                        VIEW = "\n At the westermost edge of the arch you are standing under is a tiny tower with a statue.";
                        VIEW = VIEW + "\n Beneath this statue is a small pedastel. On this pedastel sits a strange, glowing orb.";
                        print(VIEW);
          
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pick up the crystalline orb? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You decide to pick it up. When you do, the orb begins to shimmer and sparkle.");
                                 print(" It radiates the area immediately surrounding you in glowing green light.");
                                 print(" You find: the \"Orb of Oblivion\"!");
                                 Player_Heroine.INV_Has_Orb = "TRUE";
                                 globals()['Found_Orb']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" It might hurt you. Better to ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see a statue and beneath it an empty pedastel where you formerly found the Orb of Oblivion.");
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     globals()['Found_HealingPotion_CelestiasPalace'] = Find_Healing_Potion(globals()['Found_HealingPotion_CelestiasPalace']);
                     ...
                     print(" Further to the west, you see a strange pony with a lavender birthmark in the shape of a moon on her right flank.");
                     if(globals()['NPC1_Encountered'] == "FALSE"):
                        VIEW = "\n You introduce yourself. The being looks at you.";
                        if(NPC_1.EntityGender == "Female"): VIEW = VIEW + " She ";
                        else: VIEW = VIEW + " He ";
                        VIEW = VIEW + "says: \"Hello " + Player_Heroine.EntityName + ". ";
                        VIEW = VIEW + "My name is " + NPC_1.EntityName + ".\""; 
                        print(VIEW);
                        NPC_1.Speak();
                        globals()['NPC1_Encountered'] = "TRUE";
                     else: 
                        NPC_1.Speak();                        
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     globals()['Found_HealingPotion_3'] = Find_Healing_Potion(globals()['Found_HealingPotion_3']);
                     ...
                     if(globals()['Acquired_Invisibility'] == "FALSE"):
                        VIEW = "\n As you proceed through the tunnel, you notice an unusual trapazoidal stone. It is translucent,";
                        VIEW = VIEW + "\n of the consistency of amethist. Could it be valuable?";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pick up the purple trapazoidal stone and examine it? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You pick up the purple trapazoidal stone. When you flip it over, you notice some ancient-looking");
                                 print(" ruins inscribed in obsidian on the bottom. By some unknown force, you realize these ruins are the");
                                 print(" characters of an ancint language. You speak them out and disappear. You look at your hooves - they're gone!");
                                 print(" Looking for your reflection in the glossy trapazoidal stone - there is none. You acquire skill: Invisbility!");
                                 Player_Heroine.SKILL_Has_Invisibility = "TRUE";
                                 globals()['Acquired_Invisibility']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide not to pick up the stone and continue walking down the tunnel ...");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see the trapazoidal stone with ancient runes you used to formerly acquire Invisbility. You keep walking ...");     
                     ContinueIT = input("\n Press ENTER to proceed.");
...
def L1_DISCORDSLAIR():
    ...
    VIEW = VIEW + "\n To your great astonishment, you see what looks like a patchwork quilt of a dragon, made up of what looks like a";
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Found_Plate_Armor'] == "FALSE"):
                        VIEW = "\n You see an old, dusty book in the center of one shelf. It is pulled half-way out. You wonder why?";
                        VIEW = VIEW + "\n Perhaps this book was one that was recently read?";
                        print(VIEW);
          
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Attempt to pull the book from the shelf and read it? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You pull the protruding book from the shelf, but when you do, you realize it isn't a real book!");
                                 print(" Rather, it is a solid block attached by a metallic hinge to a trigger. Afer activating this trigger");
                                 print(" by moving the book at an angle down towards the floor, a panel in the bookshelf slides to the right");
                                 print(" revealing a small room. You walk inside and find a crude stone maniquin. On this maniquin is a");
                                 print(" shimmering, silver set of full body plate armor.");
                                 print(" You find: the \"Plate Armor of Perfection\"!");
                                 Player_Heroine.INV_Has_Plate_Armor = "TRUE";
                                 globals()['Found_Plate_Armor']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" It might be a trap or just an illusion. You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                                   ...
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an open panel in the book shelf leading to a small room where you formerly found the Plate Armor of Perfection.");  
                     ...
                     if(globals()['Acquired_FriendshipCast'] == "FALSE"):
                        VIEW = "\n Looking at the bowl of fruit rings on the wooden table, you are overcome with a ravenous hunger.";
                        VIEW = VIEW + "\n They look so delicious, and at this point you can't imagine anything that would be more";
                        VIEW = VIEW + "\n satisfying than to fill your mouth with all those sparkling fruity flavors!";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Dare you consume this tantalizing bowl of fruit rings? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You bury your hungry face in the fruit rings. So delicious! So tangy and sweet and citrisy!");
                                 print(" When you do, you strangely begin to feel at peace with the universe and become very calm. It is as if");
                                 print(" every being in the entire universe has suddenly become your BFF. You acquire skill: Friendship Cast!");
                                 Player_Heroine.SKILL_Has_FriendshipCast = "TRUE";
                                 globals()['Acquired_FriendshipCast']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" As delicious as they look, you choose not to eat them. What if it angered the dragon?");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an empty bowl of fruit rings on the table where you formerly ate fruit rings and acquired Friendship Cast.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
                     ...
                     if(globals()['TRAP2_Encountered'] == "FALSE"):
                        print(" \n To the west in a small, rusty cage you see a poor, grumpy, fluffy Pallas cat (Manul).");
                        print(" It's so completely FLUFFY! Never in yoru life have you seen so much fur and teeth.");
                        print(" The Pallas cat looks so miserable and sad. There is a key in the door of its cage.");
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Turn the key in the cage door and try to rescue the Pallas cat? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n [TRAP2] You turn the key and open the drusty cage door. As soon as you do,");
                                 print(" the Pallas cst jumps out of the cage with a grudge and fury of claw and fangs.");
                                 print(" It bites and scrathces you for 10 points of dammage.");
                                 Player_Heroine.EntityHealth = Player_Heroine.EntityHealth - 10;
                                 globals()['TRAP2_Encountered']  = "TRUE";
                                 print(" \n Current health - 10 =",Player_Heroine.EntityHealth); 
                              elif(CHOICE == "n"):
                                   print(" Maybe setting this grumpy Guss free would be a mistake? You leave it be.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                    print(" That choice was invalid. Ignoring it.");
                     else : 
                            print("\n You see an empty cage where formerly you freed a very angry and grumpy Pallas cat.");     
                            
                            if(globals()['Combat1_Not_Complete'] == "TRUE"):
                               print(" \n The patchwork dragon you saw before has moved beside the cage and is now staring at you."); 
                               print(" You could approach him and introduce yourself, or you could walk away.");  
                               while(CHOICE != "y" and CHOICE != "#"):
                                     CHOICE = input("\n Walk up to the dragon and introduce yourself? (Y)es or (N)o : ");
                                     CHOICE = CHOICE.lower();          
                                     if(CHOICE == "y"):
                                        print("\n You walk up to the dragon and try to strike up a conversation. But he will have none of it.");
                                        print(" He turns to you and says,",Player_Heroine.EntityName,"I KNOW who YOU are! And what you have come for!");
                                        print(" Well MY name is",Player_Opponent.EntityName ,". And I'll not have it!");
                                        ContinueIT = input("\n Press ENTER to proceed.");  
                                        Pony_Combat(Player_Heroine,Player_Opponent);
                                        globals()['Combat1_Not_Complete'] = "FALSE";
                                     elif(CHOICE == "n"):
                                          print(" You decide not to engage with the dragon. You turn and walk away. Surprisingly, he lets you leave.");
                                          CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                                     else:
                                          print(" That choice was invalid. Ignoring it.");
                            else : print("\n You see rubble and refuse and charred stone where you formerly fought the dragon.");                               
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Found_Chain_Mail'] == "FALSE"):
                        VIEW = "\n Further north you see in the thick mud and murky swamp water the glimmer of something";
                        VIEW = VIEW + "\n metallic and slinky. You walk over and investigate this slimy slinky shiny silppery mystery.";
                        print(VIEW);
          
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pull the secretive slinky slimy bundle from the bog? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You heave and ho with all your might and manage to pull the slimy metalic bundle from the bog.");
                                 print(" As yo uwipe off the mud and muck of the swamp the nature of the object begins to reveal itself.");
                                 print(" You find: the \"Chainmail of Charity\"!");
                                 Player_Heroine.INV_Has_Chain_Mail = "TRUE";
                                 globals()['Found_Chain_Mail']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" What if it's something totally GROSS? Ewwww! You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see a murky depression in the mud where you formerly found the Chainmail of Charity.");  
                     ...
                     print(" Further to the east, you see a strange moss-covered turtle soaking in the murky water.");
                     if(globals()['NPC2_Encountered'] == "FALSE"):
                        VIEW = "\n You introduce yourself. The being looks at you.";
                        if(NPC_2.EntityGender == "Female"): VIEW = VIEW + " She ";
                        else: VIEW = VIEW + " He ";
                        VIEW = VIEW + "says: \"Hello " + Player_Heroine.EntityName + ". ";
                        VIEW = VIEW + "My name is " + NPC_2.EntityName + ".\""; 
                        print(VIEW);
                        NPC_2.Speak();
                        globals()['NPC2_Encountered'] = "TRUE";
                     else: 
                        NPC_2.Speak();                        
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     print(" of interest here. Just a tall clump of grass in the middle. Odd.");
                     print(" You can go no further north from this location.");
                     globals()['Found_HealingPotion_2'] = Find_Healing_Potion(globals()['Found_HealingPotion_2']);
                     ...
                     print("\n Going WEST, you stop abruptly at a steep ledge. You can go no further.");
                     print(" You shudder to think what would happen if you slipped and fell on the sharp rocks below.");

                     if(globals()['TRAP4_Encountered'] == "FALSE"):
                        print(" A bit more towards theledge you see a hollow log. In this hollowed out log you");
                        print(" see a satchel with one leather handel protruding from the bough.");
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pull out and examine the satchel? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n [TRAP4] You tug on the leather handel of the satchel. As soon as you do,");
                                 print(" the log explodes like a bomb leaving a painful ringing in your ears.");
                                 print(" It burns your sking and lacerates your flesh for a total of 20 points of dammage.");
                                 Player_Heroine.EntityHealth = Player_Heroine.EntityHealth - 20;
                                 globals()['TRAP4_Encountered']  = "TRUE";
                                 print("Current health - 10 =",Player_Heroine.EntityHealth); 
                              elif(CHOICE == "n"):
                                   print(" What is this is some sort of TRAP? You decide not to touch it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                    print(" That choice was invalid. Ignoring it.");
                     else : 
                            print("\n You see pile of ashes where the hollow tree had formerly exploded on you.");                       
                     ContinueIT = input("\n Press ENTER to proceed."); 
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     print(" shore of a river, too broad to swim across and go any further south.");

                     if(globals()['Found_PrincessCloak'] == "FALSE"):
                        VIEW = "\n On the sandy shore a small mangrove climbs toward the sky, about 3 feet tall.";
                        VIEW = VIEW + "\n On one of its branches is a purple garment covered with pearls and shiny stones. It looks like a cloak.";
                        print(VIEW);
          
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Try on the cloak for size? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You decide to put on the cloak. It's just your size! Wearing it, you feel");
                                 print(" absolutely ROYAL. .");
                                 print(" You find: the \"Cloak of Perfect Princessness\"!");
                                 Player_Heroine.INV_Has_PrincessCloak = "TRUE";
                                 globals()['Found_PrincessCloak']  = "TRUE";
                                 Player_Heroine.Inventory_Display(); 
                              elif(CHOICE == "n"):
                                   print(" It might be a trap of just an illusion. You ignore it.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n Here is where you formerly found the Cloak of Perfect Princessness.");  
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     if(globals()['Acquired_TimeWarp'] == "FALSE"):
                        VIEW = "\n Hanging from one of the trees in the orchard among all the red delicious ones is a single silver apple, ";
                        VIEW = VIEW + "\n reflecting the light around it. You wonder - did it just grow there, all by itself?";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Pick the single silver apple and take a bite? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You pick the single silver apple and take a bite. NEVER have you tasted an apple sweeter than this!");
                                 print(" It's AMAZING! You notice while you are chewing and enjoying its sweet, crisp, delicate flavor");
                                 print(" everything around you begins to move slower. The falling leaves among the trees come to a complete stop and");
                                 print(" just hang in the air between perfectly frozen particles of dust. You acquire skill: Time Warp!");
                                 Player_Heroine.SKILL_Has_TimeWarp = "TRUE";
                                 globals()['Acquired_TimeWarp']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" What if the apple is poisonous?. You decide not to take a bite.");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see an empty stem on the tree where you formerly picked and ate the silver apple granting you Time Warp.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
                     ...
                     if(globals()['Combat2_Not_Complete'] == "TRUE"):
                        print(" \n You encounter three small dragons dressed in black, scaly armor."); 
                        print(" Will you approach them, or you will you walk away? They don't look too dangerous ...");  
                        while(CHOICE != "y" and CHOICE != "#"):
                              CHOICE = input("\n Walk up to the three dragons and introduce yourself? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You walk up to the dragons and try to exchange a friendly greeting.");
                                 print(" All three of them turn to you and say in unison,",Player_Heroine.EntityName,"We KNOW who YOU are! None may pass!");
                                 print(" Each dragon introduces itself to you before they attack:\n");
                                 for x in Opponent_Group:
                                      print("My name is",x.EntityName,".");
                                 ContinueIT = input("\n Press ENTER to proceed.");  
                                 
                                 for x in Opponent_Group:
                                     Pony_Combat(Player_Heroine,x);
                                 
                                 globals()['Combat2_Not_Complete'] = "FALSE";

                              elif(CHOICE == "n"):
                                   print(" You decide not to engage with these 3 little dragons. Maybe they aren't as friendly as they look?");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You see scratched dirt and glowing, charred embers where you formerly fought the three dragons.");                               
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     globals()['Found_HealingPotion_4'] = Find_Healing_Potion(globals()['Found_HealingPotion_4']);
                     ...
                     print(" Further to the east, you see a strange a tall, middle-aged mare.");
                     if(globals()['NPC3_Encountered'] == "FALSE"):
                        VIEW = "\n You introduce yourself. The being looks at you.";
                        if(NPC_3.EntityGender == "Female"): VIEW = VIEW + " She ";
                        else: VIEW = VIEW + " He ";
                        VIEW = VIEW + "says: \"Hello " + Player_Heroine.EntityName + ". ";
                        VIEW = VIEW + "My name is " + NPC_3.EntityName + ".\""; 
                        print(VIEW);
                        NPC_3.Speak();
                        globals()['NPC3_Encountered'] = "TRUE";
                     else: 
                        NPC_3.Speak();                        
                     ...
                     if(globals()['Acquired_Teleportation'] == "FALSE"):
                        VIEW = "\n Among all the cute fluffy bunnies, you see one holding a bag of pink marshmallows.";
                        VIEW = VIEW + "\n It holds up a sign in its paws that is barley legible. Squinting, you eventually realize the sign says:";
                        VIEW = VIEW + "\n Put this ENTIRE bag of marshmallows in your mouth and then say the words:";
                        VIEW = VIEW + "\n \"CUTE FLUFFY BUNNIES\" ten times before you swallow.";
                        print(VIEW);
                        while(CHOICE != "y" and CHOICE != "#"):
                              print(" Will you try to eat an entire bag of marshmallows at once?");
                              print(" And will you say \"CUTE FLUFFY BUNNIES\" ten times before you swallow?");
                              CHOICE = input("\n Binge on marshmallows and talk with your mouth full? (Y)es or (N)o : ");
                              CHOICE = CHOICE.lower();          
                              if(CHOICE == "y"):
                                 print("\n You do as the bunny asked. After choking on an entire bag of marshmallows you somehow");
                                 print(" manage to get them all down and say the magic words 10 times. All of a sudden you feel your");
                                 print(" body tingle all over. In the blink of an eye you see everything go dark for a secone and");
                                 print(" in the next moment as the light enters your eyes? You find yourself 100 feet away from the bunnies");
                                 print(" and standing against a tree. You acquire skill: Teleportation");
                                 Player_Heroine.SKILL_Has_Teleportation  = "TRUE";
                                 globals()['Acquired_Teleportation']  = "TRUE";
                                 Player_Heroine.SKILL_Display(); 
                              elif(CHOICE == "n"):
                                   print(" You decide no one can eat an entire bag marshmallows at once! What would happen to your figure?");
                                   CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                              else:
                                   print(" That choice was invalid. Ignoring it.");
                     else : print("\n You remember the savory taste of gluttonous amounts of pink marshmallows. Here is where you formerly found the skill of Teleportation.");     
                     ContinueIT = input("\n Press ENTER to proceed.");
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     globals()['Found_HealingPotion_1'] = Find_Healing_Potion(globals()['Found_HealingPotion_1']);
...
#Function----------------------------------------------------------------------------------------------------------------------------------------------------------------
def Find_Healing_Potion(Potion_Number):
    
    CHOICE = "";

    if(Potion_Number == "FALSE"):
       VIEW = "\n You see a glowing, blue crystal vial of liquid floating in the air.";
       VIEW = VIEW + "\n It has the aroma of honeysuckle.";
       print(VIEW);
          
       while(CHOICE != "y" and CHOICE != "#"):
             CHOICE = input("\n Do you want to take the glowing vial? (Y)es or (N)o : ");
             CHOICE = CHOICE.lower();          
             if(CHOICE == "y"):
                print("\n You decide to take the vial. You found: Healing Potion!");
                Player_Heroine.INV_Has_HealingPotions = Player_Heroine.INV_Has_HealingPotions + 1;
                Player_Heroine.Inventory_Display();
                ContinueIT = input("\n Press ENTER to proceed."); 
                return "TRUE";
             elif(CHOICE == "n"):
                  print(" It might be a trap, or just an illusion? What if it's POISON? You ignore it.");
                  CHOICE = "#"; #Must invalidate CHOICE since "n" = north in while loop below also
                  ContinueIT = input("\n Press ENTER to proceed."); 
                  return "FALSE";
             else:
           ...
           print("\n Here you formerly found a Healing Potion.");
           ContinueIT = input("\n Press ENTER to proceed.");
           return "TRUE";            
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------ 
