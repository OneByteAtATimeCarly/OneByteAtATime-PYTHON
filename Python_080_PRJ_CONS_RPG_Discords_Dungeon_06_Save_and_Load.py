...
#Title: Discord's Dungeon 06 - Coding Load and Save for Game State and Character. Basic Read and Write to files in Python. Serializing Data Members of a Class to save and load from files.
...
S1_AbominationAlive = "TRUE";
E1_BloodBatAlive = "TRUE";
W1_GiantAlive = "TRUE";
S2_MotleyCrewAlive = "TRUE";
FirstTime_CelestiasPalace = "TRUE";
...
def Initialize_Globals():
    ...
    Found_Chain_Mail = "FALSE";
    Found_Plate_Armor = "FALSE";
    Found_HealingPotion_C1 = "FALSE";
    Found_HealingPotion_N2 = "FALSE";
    Found_HealingPotion_W2 = "FALSE";
    Found_HealingPotion_S1 = "FALSE";
    Found_HealingPotion_CelestiasPalace = "FALSE";
    Acquired_IceBlasts = "FALSE";
    Acquired_FireBalls = "FALSE";
    Acquired_Lightning = "FALSE";
             ...
             print(" That was not a valid option for this particular level and map location.");
                ...
                if(CHOICE == "o"):
                   Options();
                     ...
                     print("\n You press east, but stop, afraid you will drop over a steep ledge into the valley below."); 
                     ContinueIT = input("\n Press ENTER to proceed.");
                elif(CHOICE == "w"):
                     print("\n You try to climb solid walls of stone, but you are unable.");
                     ContinueIT = input("\n Press ENTER to proceed.");
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
